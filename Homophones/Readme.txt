...
The first string is an English word, which is followed by one or more phonemes (or phones) that describe the pronunciation of the word. There are 39 phonemes occurring in North American English that are used in the dictionary. The collection of 39 symbols is known as the Arpabet, for the Advanced Research Projects Agency (ARPA), which developed it in in the 1970’s in connection with research on speech understanding.

Program takes one integer command line argument, call it k. 

The output of your program consists of k lines, the ith of which gives a word that has the ith most homophones, followed by the number of homophones.
